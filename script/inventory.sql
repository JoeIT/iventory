...
INSERT INTO `item` (`id`, `type_id`, `brand_id`, `material_id`, `color_id`, `origin_id`, `location_id`, `owner_id`, `condition_id`, `availability_id`, `code`, `new_code`, `accounting_code`, `name`, `quantity`, `unit_cost`, `minimum_cost`, `expected_cost`, `sales_cost`, `comment`, `photo_dir`, `creation_date`, `modified_date`) VALUES
	...
	(498, 15, 40, 5, 15, 6, 4, 1, 3, 1, 'X-0085', '', '', 'Impresora de carro a cinta', 1.000, 0.00, 0.00, 0.00, 0.00, '1 GLB.\r\n\r\nIMPRESORA EPSON A CINTA\r\nMODELO LX 300 + II', 'X-0085', '2014-02-21 16:02:21', NULL),
	...
	(505, 10, 84, 5, 4, 19, 6, 1, 3, 1, 'X-0086', '', '', 'Calentador de agua', 1.000, 0.00, 0.00, 0.00, 0.00, '1 PZA.\r\n\r\nCALENTADOR DE AGUA NATIONAL.', 'X-0086', '2014-02-21 16:02:27', NULL),
	...
	(529, 12, 11, 6, 5, 19, 6, 1, 4, 1, 'X-0088', '', '', 'Carrito de carga', 1.000, 0.00, 0.00, 0.00, 0.00, '1 GLB.\r\n\r\nCARRITO DE CARGA\r\nCON 4 RUEDAS\r\nCON MANGO NEGRO.', 'X-0088', '2014-02-24 09:02:11', NULL),
	...
	(547, 12, 11, 3, 12, 2, 24, 1, 3, 1, 'X-0090', '', '', 'Futbolin', 1.000, 0.00, 0.00, 0.00, 0.00, '1 GLB.\r\n\r\nFUTBOLIN DE MADERA.', 'X-0090', '2014-02-25 10:02:22', NULL),
	...
	(554, 5, 89, 6, 8, 4, 17, 1, 3, 1, 'X-0091', '', '', 'Sierra de mesa', 1.000, 0.00, 0.00, 0.00, 0.00, '1 GLB.\r\n\r\nSIERRA DE MESA\r\nMARCA NEO\r\nMODELO SM910\r\nPOTENCIA 2000W', 'X-0091', '2014-02-25 11:02:38', NULL),
	...
	(556, 3, 11, 6, 4, 19, 17, 1, 4, 1, 'X-0092', '', '', 'Mesa de trabajo', 1.000, 0.00, 0.00, 0.00, 0.00, '1 PZA.\r\n\r\nMESA DE METAL\r\nCOLOR BLANCO\r\nMEDIDAS [100cm x 100cm x 86.5cm alto]', 'X-0092', '2014-02-25 11:02:35', NULL),
	(557, 5, 90, 6, 18, 4, 17, 1, 3, 1, 'X-0093', '', '', 'Maquina cortadora', 1.000, 0.00, 0.00, 0.00, 0.00, '1 PZA.\r\n\r\nMAQUINA CORTADORA DE METAL\r\nPOTENCIA: 1800W\r\nDIAM. DISCO: 355MM.', 'X-0093', '2014-02-25 13:02:42', NULL),
	...
	(585, 3, 11, 6, 6, 19, 17, 1, 4, 1, 'X-0096', '', '', 'Mesa de trabajo', 1.000, 0.00, 0.00, 0.00, 0.00, '1 PZA.\r\n\r\nMESA DE TRABAJO METALICA\r\nCOLOR VERDE\r\nMEDIDAS [189cm x 65cm x 105cm alto]', 'X-0096', '2014-02-26 16:02:41', NULL),
	...
	(594, 15, 7, 5, 2, 5, 8, 1, 3, 1, 'X-0098', '', '', 'Monitor LCD', 1.000, 0.00, 0.00, 0.00, 0.00, '1 PZA.\r\n\r\nMONITOR LCD\r\nMARCA DELL\r\nMODELO E177FPF\r\nTAMAÃ‘O 17 PULGADAS\r\n\r\nPOSIBLE CODIGO 07-066', 'X-0098', '2014-02-26 17:02:12', NULL),
	...
	(609, 10, 22, 5, 4, 6, 8, 1, 3, 1, 'X-0099', '', '', 'TelÃ©fono digital', 1.000, 0.00, 0.00, 0.00, 0.00, '1 GLB.\r\n\r\nTELEFONO DIGITAL\r\nMARCA: PANASONIC\r\nMODELO: KX-TS580LX\r\nSERIE: 2EBKC072295', 'X-0099', '2014-02-27 15:02:11', NULL),
	...
	(616, 10, 24, 5, 2, 24, 8, 1, 3, 1, 'X-0101', '', '', 'Radio', 1.000, 0.00, 0.00, 0.00, 0.00, '1 GLB.\r\n\r\nRADIO\r\nCON 2 PARLANTES.', 'X-0101', '2014-02-27 16:02:08', NULL),
	(617, 3, 11, 6, 10, 19, 8, 1, 3, 1, 'X-0102', '', '', 'Mesa de escritorio', 1.000, 0.00, 0.00, 0.00, 0.00, '1 PZA.\r\n\r\nMESA DE METAL\r\nCON BASE DE MADERA PRENSADA\r\nMEDIDAS [125cm x 56cm x 76cm alto]', 'X-0102', '2014-02-27 16:02:12', NULL),
	...
	(619, 12, 11, 5, 18, 19, 8, 1, 3, 1, 'X-0103', '', '', 'BOTIQUIN', 1.000, 0.00, 0.00, 0.00, 0.00, '1 PZA.\r\n\r\nBOTIQUIN DE PRIMEROS AUXILIOS\r\nCOLOR NARANJA Y NEGRO.', 'X-0103', '2014-02-27 16:02:35', NULL),
